                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="breakfast" name="breakfast" id="breakfast"
                                    class="form-control @error('breakfast') is-invalid @enderror" value="{{ old('breakfast') }}"
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" name="lunch" id="lunch"
                                    ...
                                    value="{{ old('lunch') }}" placeholder="Enter guardian name!">
                                @error('lunch')
                                    <div class="text-danger">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="dinner" name="dinner" id="dinner"
                                    ...
                                    value="{{ old('dinner') }}" placeholder="Enter guardian CNIC!">
                                @error('dinner')
                                    <div class="text-danger">{{ $message }}</div>
                                @enderror
                            </div>
